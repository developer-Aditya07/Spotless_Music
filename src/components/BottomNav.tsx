...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav
      ...
      className="md:hidden flex items-center justify-around bg-[#121212]/95 backdrop-blur-lg border-t border-[#282828] py-2 px-3 z-40 select-none pb-[calc(env(safe-area-inset-bottom,8px)+8px)]"
    >
      <button
